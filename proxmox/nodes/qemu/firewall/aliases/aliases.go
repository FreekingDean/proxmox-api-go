...
func (c *Client) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	err := c.httpClient.Do(ctx, "/nodes/{node}/qemu/{vmid}/firewall/aliases", "POST", &resp, req)
	return resp, err
}
...
func (c *Client) Update(ctx context.Context, req *UpdateRequest) (*UpdateResponse, error) {
	...
	err := c.httpClient.Do(ctx, "/nodes/{node}/qemu/{vmid}/firewall/aliases/{name}", "PUT", &resp, req)
	return resp, err
}
...
func (c *Client) Delete(ctx context.Context, req *DeleteRequest) (*DeleteResponse, error) {
	...
	err := c.httpClient.Do(ctx, "/nodes/{node}/qemu/{vmid}/firewall/aliases/{name}", "DELETE", &resp, req)
	return resp, err
}
