...
func (c *Client) Create(ctx context.Context, req CreateRequest) error {
	...
	err := c.httpClient.Do(ctx, "/nodes/{node}/qemu/{vmid}/firewall/ipset", "POST", nil, req)
	return err
}
...
func (c *Client) ChildCreate(ctx context.Context, req ChildCreateRequest) error {
	...
	err := c.httpClient.Do(ctx, "/nodes/{node}/qemu/{vmid}/firewall/ipset/{name}", "POST", nil, req)
	return err
}
...
func (c *Client) Delete(ctx context.Context, req DeleteRequest) error {
	...
	err := c.httpClient.Do(ctx, "/nodes/{node}/qemu/{vmid}/firewall/ipset/{name}", "DELETE", nil, req)
	return err
}
...
func (c *Client) UpdateIpCidr(ctx context.Context, req UpdateIpCidrRequest) error {
	...
	err := c.httpClient.Do(ctx, "/nodes/{node}/qemu/{vmid}/firewall/ipset/{name}/{cidr}", "PUT", nil, req)
	return err
}
...
func (c *Client) RemoveIpCidr(ctx context.Context, req RemoveIpCidrRequest) error {
	...
	err := c.httpClient.Do(ctx, "/nodes/{node}/qemu/{vmid}/firewall/ipset/{name}/{cidr}", "DELETE", nil, req)
	return err
}
