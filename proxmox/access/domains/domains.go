...
type CreateRequest struct {
	...
	Autocreate          *util.SpecialBool `url:"autocreate,omitempty",json:"autocreate,omitempty"`                       // Automatically create users if they do not exist.
	...
	CaseSensitive       *util.SpecialBool `url:"case-sensitive,omitempty",json:"case-sensitive,omitempty"`               // username is case-sensitive
	...
	Default             *util.SpecialBool `url:"default,omitempty",json:"default,omitempty"`                             // Use this as default realm
	...
	Secure              *util.SpecialBool `url:"secure,omitempty",json:"secure,omitempty"`                               // Use secure LDAPS protocol. DEPRECATED: use 'mode' instead.
...
type SyncRequest struct {
	...
	// The following parameters are optional
	DryRun         *util.SpecialBool `url:"dry-run,omitempty",json:"dry-run,omitempty"`                 // If set, does not write anything.
	EnableNew      *util.SpecialBool `url:"enable-new,omitempty",json:"enable-new,omitempty"`           // Enable newly synced users immediately.
	Full           *util.SpecialBool `url:"full,omitempty",json:"full,omitempty"`                       // DEPRECATED: use 'remove-vanished' instead. If set, uses the LDAP Directory as source of truth, deleting users or groups not returned from the sync and removing all locally modified properties of synced users. If not set, only syncs information which is present in the synced data, and does not delete or modify anything else.
	Purge          *util.SpecialBool `url:"purge,omitempty",json:"purge,omitempty"`                     // DEPRECATED: use 'remove-vanished' instead. Remove ACLs for users or groups which were removed from the config during a sync.
