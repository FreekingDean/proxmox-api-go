...
const (
	Preallocation_OFF      Preallocation = "off"
	Preallocation_METADATA Preallocation = "metadata"
	Preallocation_FALLOC   Preallocation = "falloc"
	Preallocation_FULL     Preallocation = "full"

	Smbversion_DEFAULT Smbversion = "default"
	Smbversion_2_0     Smbversion = "2.0"
	Smbversion_2_1     Smbversion = "2.1"
	Smbversion_3       Smbversion = "3"
	Smbversion_3_0     Smbversion = "3.0"
	Smbversion_3_11    Smbversion = "3.11"

	Transport_TCP  Transport = "tcp"
	Transport_RDMA Transport = "rdma"
	Transport_UNIX Transport = "unix"

	Type_BTRFS       Type = "btrfs"
	Type_CEPHFS      Type = "cephfs"
	Type_CIFS        Type = "cifs"
	Type_DIR         Type = "dir"
	Type_GLUSTERFS   Type = "glusterfs"
	Type_ISCSI       Type = "iscsi"
	Type_ISCSIDIRECT Type = "iscsidirect"
	Type_LVM         Type = "lvm"
	Type_LVMTHIN     Type = "lvmthin"
	Type_NFS         Type = "nfs"
	Type_PBS         Type = "pbs"
	Type_RBD         Type = "rbd"
	Type_ZFS         Type = "zfs"
	Type_ZFSPOOL     Type = "zfspool"
)
...
func PtrTransport(i Transport) *Transport {
	return &i
}
...
type CreateRequest struct {
	...
	Type    Type   `url:"type" json:"type"`       // Storage type.
	...
	Fuse                 *util.PVEBool  `url:"fuse,omitempty" json:"fuse,omitempty"`                                   // Mount CephFS through FUSE.
	...
	Krbd                 *util.PVEBool  `url:"krbd,omitempty" json:"krbd,omitempty"`                                   // Always access rbd through krbd kernel module.
	...
	Mkdir                *util.PVEBool  `url:"mkdir,omitempty" json:"mkdir,omitempty"`                                 // Create the directory if it doesn't exist.
	...
	Preallocation        *Preallocation `url:"preallocation,omitempty" json:"preallocation,omitempty"`                 // Preallocation mode for raw and qcow2 images. Using 'metadata' on raw images results in preallocation=off.
	...
	Saferemove           *util.PVEBool  `url:"saferemove,omitempty" json:"saferemove,omitempty"`                       // Zero-out data when removing LVs.
	...
	Shared               *util.PVEBool  `url:"shared,omitempty" json:"shared,omitempty"`                               // Mark storage as shared.
	Smbversion           *Smbversion    `url:"smbversion,omitempty" json:"smbversion,omitempty"`                       // SMB protocol version. 'default' if not set, negotiates the highest SMB2+ version supported by both the client and server.
	Sparse               *util.PVEBool  `url:"sparse,omitempty" json:"sparse,omitempty"`                               // use sparse volumes
	Subdir               *string        `url:"subdir,omitempty" json:"subdir,omitempty"`                               // Subdir to mount.
	TaggedOnly           *util.PVEBool  `url:"tagged_only,omitempty" json:"tagged_only,omitempty"`                     // Only use logical volumes tagged with 'pve-vm-ID'.
...
type CreateResponse struct {
	...
	Type    Type   `url:"type" json:"type"`       // The type of the created storage.
