...
type SetOptionsRequest struct {
	...
	MigrationUnsecure *bool   `url:"migration_unsecure,omitempty",json:"migration_unsecure,omitempty"` // Migration is secure using SSH tunnel by default. For secure private networks you can disable it to speed up migration. Deprecated, use the 'migration' property instead!
