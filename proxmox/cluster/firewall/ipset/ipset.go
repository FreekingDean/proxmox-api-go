...
func (c *Client) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	err := c.httpClient.Do(ctx, "/cluster/firewall/ipset", "POST", &resp, req)
	return resp, err
}
...
func (c *Client) ChildCreate(ctx context.Context, req *ChildCreateRequest) (*ChildCreateResponse, error) {
	...
	err := c.httpClient.Do(ctx, "/cluster/firewall/ipset/{name}", "POST", &resp, req)
	return resp, err
}
...
func (c *Client) Delete(ctx context.Context, req *DeleteRequest) (*DeleteResponse, error) {
	...
	err := c.httpClient.Do(ctx, "/cluster/firewall/ipset/{name}", "DELETE", &resp, req)
	return resp, err
}
...
func (c *Client) UpdateIpCidr(ctx context.Context, req *UpdateIpCidrRequest) (*UpdateIpCidrResponse, error) {
	...
	err := c.httpClient.Do(ctx, "/cluster/firewall/ipset/{name}/{cidr}", "PUT", &resp, req)
	return resp, err
}
...
func (c *Client) RemoveIpCidr(ctx context.Context, req *RemoveIpCidrRequest) (*RemoveIpCidrResponse, error) {
	...
	err := c.httpClient.Do(ctx, "/cluster/firewall/ipset/{name}/{cidr}", "DELETE", &resp, req)
	return resp, err
}
